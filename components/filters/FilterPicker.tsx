...
import type { CardFilterOption } from "../../lib/card-filters";
import styles from "./FilterPicker.module.css";

export type FilterOption = CardFilterOption;
...
export function FilterPicker({
  ...
  const selectedOptions = useMemo(
    () => localValues.map((value) => options.find((option) => option.value === value)).filter(Boolean) as FilterOption[],
    [localValues, options],
  );
