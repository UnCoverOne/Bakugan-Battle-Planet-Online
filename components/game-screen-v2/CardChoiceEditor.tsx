...
function changed(choices: CardChoices, field: ChoiceField, values: string[]) {
  const next = { ...choices };
  if (field.maximum > 1 || ["discardCardIds", "handCardIds", "targetEnergyIds"].includes(field.id)) {
