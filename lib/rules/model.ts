...
export type RuleAction =
  ...
  | { kind: "negate"; cardType: "Action" | "Hero" | "Baku-Gear" | "any"; copy: boolean; targetChoiceId?: keyof CardChoices; maximumCost?: NumberValue; targetKinds?: Array<"card" | "trigger" | "copy">; destination?: { zone: "energy"; player: "target-controller"; enters: "charged" | "uncharged" } }
